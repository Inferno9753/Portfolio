      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveLarge ? (
          <div
            ...
            before:w-full before:max-w-[400px] md:before:max-w-[600px] before:h-[500px] before:border-2 before:border-blue before:z-[-1]"
          >
            <img
              alt="profile"
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          ...
          <AnchorLink
            ...
            href="#contact"
          >
            <div className="bg-deep-blue hover:text-sky-700 transition duration-500 w-full h-full flex items-center justify-center px-10 font-playfair">
              Let's talk.
            </div>
          </AnchorLink>
        </motion.div>
